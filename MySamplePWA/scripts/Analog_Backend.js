...
var Curr_AX_Cal_Vals = [0,0,0,0,0,0,0,0,0];
var Curr_AY_Cal_Vals = [0,0,0,0,0,0,0,0,0];
var Curr_CX_Cal_Vals = [0,0,0,0,0,0,0,0,0];
var Curr_CY_Cal_Vals = [0,0,0,0,0,0,0,0,0];
...
function storeValue(){
    ...
    if(storageCounter >= doneCalibratingVal){
        doneCalibration();
    }
